...
export default function ClienteMenu(){
 ...
 return <div className={styles.root}>
  <button className={styles.menuButton} type="button" aria-label="Abrir menu do cliente" aria-expanded={open} onClick={()=>setOpen(v=>!v)}><span>☰</span><strong>Menu</strong></button>
